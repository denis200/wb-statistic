...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('statistic', '0009_alter_productcard_user'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='code',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='statistic.productcard', verbose_name='Артикул'),
        ),
    ]
